...
> **2026-09-18 当前科学方案：cvpr27-20260918-v1.3。** [共享计划](WORK_PLAN.md)已验收C的软件与100条既有开发元数据描述范围；旧时间字段确认为best-effort，原生整数PTS/time_base仍未验证。A参考与C定义不变，真实采集、预算、机制和训练未放行；当前任务以project.json为准，下方旧“当前”字样均属历史。
